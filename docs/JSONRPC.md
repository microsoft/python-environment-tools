...
- Unix probes start in a new process group. PET signals that group before reaping its leader, avoiding process-ID reuse. Descendants that deliberately start another group/session escape this boundary; PET does not act as a system-wide descendant reaper.
